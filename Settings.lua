...
local function createMiniListFrame(parent)
	...
	itemFrame:SetSize(child:GetWidth()/2.5,330) -- Increase by 20 per new option
...
local function createAboutFrame(parent)
	...
	text.a9 = "PvP items are not able to be filtered out.  This is because about a third to a half of the available appearances come from PvP gear and are purchasable with Honor Points. You can filter out PvP items that are unobtainable or only available to top-tier PvPers, like Elite and Gladiator items by turning on the 'PvP Elite/Gladiator' filter under 'Account Filters'  Current season gear is excluded from this filter as it is still obtainable at the time (this may change in the future).\n \n";

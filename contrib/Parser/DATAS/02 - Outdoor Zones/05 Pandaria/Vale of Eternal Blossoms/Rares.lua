				...
				["g"] = {
					n(-16, { 	-- Rares
						...
						{	-- Aetha
							...
							["g"] = {
								{	-- Treasures of the Vale
									["itemID"] = 103624,	-- Treasures of the Vale
								},
							},
						},
						{	-- Ai-Ran the Shifting Cloud
							["npcID"] = 50822,	-- Ai-Ran the Shifting Cloud
							["coords"] = {
								{ 42.84, 69.26, 390 },
							},
							["g"] = {
								{	-- Cloak of Tranquil Clouds
									["itemID"] = 87638,	-- Cloak of Tranquil Clouds
								},
								{	-- Essence of the Breeze
									["itemID"] = 86590,	-- Essence of the Breeze
								},
								{	-- Jade Harbinger's Cloak
									["itemID"] = 87637,	-- Jade Harbinger's Cloak
								},
								{	-- Softfoot's Drape
									["itemID"] = 87640,	-- Softfoot's Drape
								},
								{	-- Cloak of the Forgotten Emperor
									["itemID"] = 87636,	-- Cloak of the Forgotten Emperor
								},
								{	-- Tattered Guo-Lai Dynasty Cloak
									["itemID"] = 87639,	-- Tattered Guo-Lai Dynasty Cloak
								},
								{	-- Small Bag of Goods
									["itemID"] = 87217,	-- Small Bag of Goods
								},
							},
						},
						{	-- Alani
							...
							["g"] = {
								{	-- Reins of the Thundering Ruby Cloud Serpent
									["itemID"] = 90655,	-- Reins of the Thundering Ruby Cloud Serpent
								},
							},
						},
						{	-- Bai-Jin the Butcher
							["npcID"] = 58949,	-- Bai-Jin the Butcher
							["coords"] = {
								{ 17.05, 48.73, 390 },
							},
							["g"] = {
						...
						{	-- Baolai the Immolator
							["npcID"] = 63695,	-- Baolai the Immolator
							["coords"] = {
								{ 28.71, 43.32, 390 },
							},
							["g"] = {
						...
						{	-- Gaohun the Soul-Severer
							["npcID"] = 62881,	-- Gaohun the Soul-Severer
							["coords"] = {
								{ 22.43, 26.75, 395 },	-- Entrance
								{ 53.16, 59.31, 395 },
							},
						...
						{	-- Gochao the Ironfist
							["npcID"] = 62880,	-- Gochao the Ironfist
							["coords"] = {
								{ 26.86, 13.08, 390 },
							},
							["g"] = {
						...
						{	-- Kal'tik the Blight
							["npcID"] = 50749,	-- Kal'tik the Blight
							["coords"] = {
								{ 14.01, 58.61, 390 },
							},
							["g"] = {
								...
								{	-- Cloak ok Tranquil Clouds
									["itemID"] = 87638,	-- Cloak ok Tranquil Clouds
								},
								{	-- Softfoot's Drape
									["itemID"] = 87640,	-- Softfoot's Drape
								},
						...
						{	-- Kang the Soul Thief
							["npcID"] = 50349,	-- Kang the Soul Thief
							["coords"] = {
								{ 15.26, 35.21, 390 },
							},
							["g"] = {
						...
						{	-- Shadowmaster Sydow
							["npcID"] = 63240,	-- Shadowmaster Sydow
							["coords"] = {
								{ 30.56, 78.44, 390 },
							},
							["g"] = {

...
--]]
	n(-5352, { -- Tier Sets
			...
			["groups"] = {
				gs(356, {	-- Vestments of Transcendence
					["groups"] = {
						...
						i(16922),	-- Leggings of Transcendence
						i(16919),	-- Boots of Transcendence
					},
					["classes"] = { 5 },
				}),		
				gs(909, {	-- Netherwind Regalia	
					["groups"] = {
						...
						i(16915),	-- Netherwind Pants
						i(16912),	-- Netherwind Boots
					},
					["classes"] = { 8 },
				}),		
				gs(867, {	-- Nemesis Raiment
					["groups"] = {	
						...
						i(16930),	-- Nemesis Leggings
						i(16927),	-- Nemesis Boots
					},
					["classes"] = { 9 },
				}),		
				gs(927, {	-- Stormrage Raiment
					["groups"] = {	
						...
						i(16901),	-- Stormrage Legguards
						i(16898),	-- Stormrage Boots
					},
					["classes"] = { 11 },
				}),		
				gs(893, {	-- Bloodfang Armor
					["groups"] = {	
						...
						i(16909),	-- Bloodfang Pants
						i(16906),	-- Bloodfang Boots
					},
					["classes"] = { 4 },
				}),		
				gs(916, {	-- Dragonstalker Armor
					["groups"] = {	
						...
						i(16938),	-- Dragonstalker's Legguards
						i(16941),	-- Dragonstalker's Greaves
					},
					["classes"] = { 3 },
				}),		
				gs(875, {	-- The Ten Storms	
					["groups"] = {
						...
						i(16946),	-- Legplates of Ten Storms
						i(16949),	-- Greaves of Ten Storms
					},
					["classes"] = { 7 },
				}),		
				gs(901, {	-- Judgment Armor
					["groups"] = {	
						...
						i(16954),	-- Judgment Legplates
						i(16957),	-- Judgment Sabatons
					},
					["classes"] = { 2 },
				}),		
				gs(852, {	-- Battlegear of Wrath
					["groups"] = {	
		...
		n(-3178, { -- Tier 3.5 (Dungeon Set 3)
			...
			n(-3288, {	-- Oblivion Raiment		
				["groups"] = {		
					i(28415),	-- Hood of Oblivion
					i(27778),	-- Spaulders of Oblivion
					i(28232),	-- Robe of Oblivion
					i(27537),	-- Gloves of Oblivion
					i(27948),	-- Trousers of Oblivion
				},		
				["icon"] = "Interface\\Icons\\inv_helmet_30",		
				["classes"] = { 9 },		
			}),			
			n(-3295, {	-- Mana-Etched Regalia		
				["groups"] = {		
			...
			n(-3291, {	-- Beast Lord Armor		
				["groups"] = {		
					i(28275),	-- Beast Lord Helm
					i(27801),	-- Beast Lord Mantle
					i(28228),	-- Beast Lord Cuirass
					i(27474),	-- Beast Lord Handguards
					i(27874),	-- Beast Lord Leggings
				},		
				["icon"] = "Interface\\Icons\\inv_helmet_19",		
				["classes"] = { 3 },		
			}),			
			n(-3292, {	-- Tidefury Raiment		
				["groups"] = {		
					i(28349),	-- Tidefury Helm
					i(27802),	-- Tidefury Shoulderguards
		...
		n(-3159, { -- Tier 6.5 (Sunwell Plateau)
			["groups"] = {
				...
				gs(911, {	-- Gronnstalker's Battlegear			
					["groups"] = {			
				...
				gs(869, {	-- Skyshatter Raiment			
					["groups"] = {			
						n(-9939, {	-- Elemental	
							i(34332),	-- Cowl of Gul'dan
							i(34208),	-- Equilibrium Epautlets
				...
				gs(895, {	-- Lightbringer Battlegear			
					["groups"] = {			
						n(-9942, {	-- Holy	
		...
		n(-3174, { -- Tier 7 (Naxxramas - Wrath
			["groups"] = {
				n(-372, {	-- 10 Player					
					["groups"] = {					
						gs(361, {	-- Heroes' Regalia of Faith			
							["groups"] = {			
								n(-9951, {	-- Discipline / Holy Priest Spec	
						...
						gs(678, {	-- Heroes' Plagueheart Garb			
							["groups"] = {			
						...
						gs(829, {	-- Heroes' Dreamwalker Battlegear			
							["groups"] = {			
								n(-9952, {	--Guardian / Feral Druid Spec	
						...
						gs(694, {	-- Heroes' Bonescythe Battlegear			
							["groups"] = {			
						...
						gs(742, {	-- Heroes' Cryptstalker Battlegear			
							["groups"] = {			
						...
						gs(644, {	-- Heroes' Earthshatter Regalia			
							["groups"] = {			
								n(-9939, {	-- Elemental	
						...
						gs(710, {	-- Heroes' Redemption Plate			
							["groups"] = {			
								n(-9942, {	-- Holy	
									...
									i(39369),	-- Tainted Girdle of Mending
								}),		
								n(-9943, {	-- Protection	
						...
						gs(661, {	-- Heroes' Dreadnaught Battlegear			
							["groups"] = {			
								n(-9953, {	-- Arms / Fury Warrior Spec	
						...
						gs(845, {	-- Heroes' Scourgeborne Plate			
							["groups"] = {			
								n(-9948, {	-- Blood	
			...
			["groups"] = {						
				n(-376, { -- Normal					
					["groups"] = {				
						...
						gs(715, {	-- Firehawk Robes of Conflaguration		
							["groups"] = {		
						...
						gs(667, {	-- Balespider's Burning Vestments		
							["groups"] = {		
						...
						gs(818, {	-- Obsidian Arborweave Vestments		
							["groups"] = {		
						...
						gs(683, {	-- Vestments of the Dark Phoenix		
							["groups"] = {		
						...
						gs(731, {	-- Flamewalker's Battlegear		
							["groups"] = {		
						...
						gs(699, {	-- Battleplate of Immolation		
							["groups"] = {		
						...
						gs(834, {	-- Elementium Deathplate Battlearmor		
							["groups"] = {		
				...
				n(-377, { -- Heroic					
					["groups"] = {				
						...
						gs(716,  {	-- Firehawk Robes of Conflaguration		
							["groups"] = {		
						...
						gs(668, {	-- Balespider's Burning Vestments		
							["groups"] = {		
						...
						gs(819, {	-- Obsidian Arborweave Vestments		
							["groups"] = {		
						...
						gs(684, {	-- Vestments of the Dark Phoenix		
							["groups"] = {		
						...
						gs(732, {	-- Flamewalker's Battlegear		
							["groups"] = {		
						...
						gs(700, {	-- Battleplate of Immolation		
							["groups"] = {		
						...
						gs(652, {	-- Molten Giant Battleplate		
							["groups"] = {		
						...
						gs(835, {	-- Elementium Deathplate Battlearmor		
							["groups"] = {		
